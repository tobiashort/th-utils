...
func AddKey(keyType string, desc string, payload []byte, ringid int) (id int, err error) {
	var _p0 *byte
	_p0, err = BytePtrFromString(keyType)
	if err != nil {
		return
	...
	var _p1 *byte
	_p1, err = BytePtrFromString(desc)
	if err != nil {
		return
	}
...
func RequestKey(keyType string, desc string, callback string, destRingid int) (id int, err error) {
	var _p0 *byte
	_p0, err = BytePtrFromString(keyType)
	if err != nil {
		return
